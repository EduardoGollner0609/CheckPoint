package com.gollner.checkpoint.controllers.hadlers;

import com.gollner.checkpoint.entities.exceptions.StandardError;
import com.gollner.checkpoint.entities.exceptions.ValidationError;
import com.gollner.checkpoint.services.exceptions.DatabaseException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<StandardError> generic(Exception e, HttpServletRequest request) {
        ...
        err.setMessage("Erro inesperado. Tente novamente.");
        err.setPath(request.getRequestURI());
